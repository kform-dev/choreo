...
func (r *dynamicAddressApplicator) Validate(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
	return nil
}

func (r *dynamicAddressApplicator) Apply(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
...
func (r *dynamicAddressApplicator) validateExists(ctx context.Context, claim *ipamv1alpha1.IPClaim) (*iputil.Prefix, error) {
...
func (r *dynamicAddressApplicator) claimIP(ctx context.Context, claim *ipamv1alpha1.IPClaim) (*iputil.Prefix, error) {
...
func (r *dynamicAddressApplicator) selectAddress(_ context.Context, claim *ipamv1alpha1.IPClaim, parentRoutes table.Routes) (*iputil.Prefix, error) {
	...
	for _, parentRoute := range parentRoutes {
		...
		case ipamv1alpha1.IPClaimSummaryType_Range:
		...
		case ipamv1alpha1.IPClaimSummaryType_Prefix:
			if parentIPPrefixType != nil && (*parentIPPrefixType == ipamv1alpha1.IPPrefixType_Network || *parentIPPrefixType == ipamv1alpha1.IPPrefixType_Pool) {
				...
				if isParentRouteSelectable(parentRoute, uint8(prefixLength)) {
					...
					if p.IsValid() {
						...
						if *parentIPPrefixType == ipamv1alpha1.IPPrefixType_Network {
...
func (r *dynamicAddressApplicator) Delete(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
	log := log.FromContext(ctx)
	log.Debug("delete")
