...
func (r *dynamicPrefixApplicator) Validate(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
	return nil
}

func (r *dynamicPrefixApplicator) Apply(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
...
func (r *dynamicPrefixApplicator) validateExists(ctx context.Context, claim *ipamv1alpha1.IPClaim) (*iputil.Prefix, error) {
...
func (r *dynamicPrefixApplicator) claimPrefix(ctx context.Context, claim *ipamv1alpha1.IPClaim) (*iputil.Prefix, error) {
	log := log.FromContext(ctx)
...
func (r *dynamicPrefixApplicator) Delete(ctx context.Context, claim *ipamv1alpha1.IPClaim) error {
	log := log.FromContext(ctx)
	log.Debug("delete")
